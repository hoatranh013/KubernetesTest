...
public class Program
{
    public static async Task Main()
    {
        ...
        var getClientType = "DeleteFriendsNotification";
        ...
        _consumer.Subscribe("DeleteFriendsNotification");
        ...
        while (true)
        {
            ...
            var requestNotificationModel = JsonConvert.DeserializeObject<DeleteFriendNotification>(messageValue);
